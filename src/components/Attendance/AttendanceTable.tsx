...
// //   // My attendance data (last 3 days with real day names)
...
// //     // Get last 3 days with real dates
// //     const today = new Date();
// //     const last3Days = [];
...
// //       // Find user's attendance for this day
...
// //         userRecord.workingTime !== "-"
// //       ) {
// //         const match = userRecord.workingTime.match(/(\d+)h/);
// //         if (match) {
...
//   const [myAttendance, setMyAttendance] = useState<any[]>([]);
//   const [attendanceView, setAttendanceView] = useState<"week" | "month">(
//     "week"
//   );
...
//                   onChange={(value) => setAttendanceView(value)}
//                   style={{ width: 100 }}
//                   size="small"
//                 >
...
//                       dataKey="day"
//                       style={{
//                         fontSize: attendanceView === "month" ? "8px" : "10px",
//                       }}
